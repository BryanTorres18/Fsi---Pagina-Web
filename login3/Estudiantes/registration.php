...
<head>
    ...
    <title> ESTUDIANTES - REGISTRAR </title>
    <meta charset="utf-8">
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="users.php" class="nav-link px-5 link-secondary">Estudiantes</a></li>
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <h1 class="display-5 fw-bold">Registrar Estudiantes</h1>
    </div>
</div>
    <!-- Registar un usuario -->
        ...
        <form id="form1" form action= "register.php" method="POST" class="needs-validation" novalidate>
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input placeholder="DNI-CARNET DE EXTRANJERIA-PASAPORTE" name="id" type="text" class="form-control" required>
                      <div class="invalid-feedback"> Complete el campo.</div>    
                    </div>
                    <div class="col-md-4 mb-3">
                      <label for="apellido">Nombre</label>
                      <input type="text" placeholder="Nombre" name="firstname" class="form-control" required>
                      <div class="invalid-feedback"> Complete el campo.</div>   
                    </div>
                  </div>
                  <div class="col-md-4 mb-3">
                      <label for="apellido">Apellidos</label>
                      <input type="text" placeholder="Apellidos" name="last_name" class="form-control" required>
                      <div class="invalid-feedback"> Complete el campo.</div>   
                    </div>
                  </div>
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <div class="input-group">
                        <input input type="text" placeholder="Direccion" name="direction" class="form-control" required>
                      <div class="invalid-feedback">Complete el campo.</div>   
                      </div>
                    </div>
                    <div class="col-md-4 mb-3">
