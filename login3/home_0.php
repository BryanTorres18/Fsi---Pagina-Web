...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <div class="col-md-3 text-end">
        ...
        <button type="button" class="btn btn-personal">Sign-up</button>-->
      </div>
    </header>
  </div>
  ...
  <div class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        ...
        <a type="button" class="btn btn-success btn-lg px-4 gap-3" href="home.php">USUARIO</a>
        <a type="button" class="btn btn-success btn-lg px-4 gap-3" href="Estudiantes/home.php">ESTUDIANTES</a>
        <a type="button" class="btn btn-success btn-lg px-4 gap-3" href="Servicios/home.php">SERVICIOS</a>
        <a type="button" class="btn btn-success btn-lg px-4 gap-3" href="servicioCliente/home.php">SERVICIO-CLIENTE</a>
      </div>
    </div>
</div>
