...
<head>
    ...
    <title> SERVICIO-CLIENTE - REGISTRAR </title>
    <meta charset="utf-8">
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="users.php" class="nav-link px-5 link-secondary">ServicioCliente</a></li>
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <h1 class="display-5 fw-bold">Registrar Servicio-Cliente</h1>
    </div>
</div>
    <!-- Registar un usuario -->
    ...
    <div class="container">
        ...
        <form id="form1" form action= "register.php" method="POST" class="needs-validation" novalidate>
                  ...
                  <button class="btn btn-primary" type="submit">Registrar servicio-cliente</button>
                </form>
        </div>   
    </div>
            </div>       
